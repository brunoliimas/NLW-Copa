    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          />
          <button
            className="bg-yellow-500 hover:bg-yellow-600 px-6 py-4 rounded uppercase font-bold text-sm"
            type="submit">Criar o meu bolão</button>
        </form>
      ...
      <Image
        src={appPreviewImage}
        alt="Mockup com preview do aplicativo"
        quality={100}
        width={518}
        height={605}
      />
